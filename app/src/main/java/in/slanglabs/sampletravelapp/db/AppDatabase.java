...
import in.slanglabs.sampletravelapp.Model.PlaceFts;
import in.slanglabs.sampletravelapp.TimeJsonAdapter;
import in.slanglabs.sampletravelapp.db.Convertors.DateConverter;
import in.slanglabs.sampletravelapp.db.Convertors.PlaceConvertor;
...
@Database(entities = {OrderItem.class, Journey.class, Bus.class, Place.class, BusAttributes.class, PlaceFts.class}, version = 7)
